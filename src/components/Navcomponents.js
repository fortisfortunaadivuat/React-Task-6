                ...
                <div className="row justify-content-center bg-info">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hi! There, I am Pratik Prabhakar</h1>
            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)"}}>
                        <h1>
                            <div class="display-4">Pratik Prabhakar</div>
                            <div class="lead text-muted"><i class="bi bi-file-earmark-person"></i> Coding | Probelm Solving</div>
                        </h1>
                        <hr />
                        <div class="contact">
                            <p class="lead pt-0">Im currently learning Data Structures and algorithms and MERN-Stack</p>
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me : 
                                <a href="mailto:pratik.prabhakar2021@vitstudent.ac.in" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            <span class="lead"><i class="bi bi-geo-fill"></i> Ranchi, Jharkhand</span>
                            <br /><br />
                            <span class="lead fw-900"><i class="bi bi-at"></i> Connect with me : </span>
                            <p class="btn-group">
                                <a href="https://www.linkedin.com/in/pratik-prabhakar-72b391272/" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> Linked In</a>
                                <a href="https://github.com/fortisfortunaadivuat?tab=repositories" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <span class="tt" data-bs-placement="bottom" title="PRATIK PRABHAKAR">
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/fortisfortunaadivuat?tab=repositories" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-primary border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://leetcode.com/" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    {/* <div class="col-8 col-lg-4 col-xl-3">
                    ...
                    <div class="col-lg-6">
                        <form action="">
                            ...
                            <div class="mb-4 input-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="e.g. Pratik Prabhakar" required/>
                            ...
                            <div class="input-group mb-4">
                                ...
                                <select class="form-select" aria-label="Default select example" id="subject">
                                    ...
                                    <option value="machine learning">Leetcode</option>
